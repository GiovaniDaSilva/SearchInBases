...
namespace SearchInBases.Entity
{
    public class SQLParams
    {
        ...
        public bool apenasAgenciaTT { get; set; }

        public SQLFiltro filtro{ get; set; }

        public List<string> basesFiltradas { get; set; }

        public SQLParams(string sql, SQLFiltro filtro, List<string> basesFiltradas, bool apenasAgenciaTT)
        {
            this.sql = sql;
            this.filtro = filtro;
            this.basesFiltradas = basesFiltradas;
            this.apenasAgenciaTT = apenasAgenciaTT;
        }
    }
